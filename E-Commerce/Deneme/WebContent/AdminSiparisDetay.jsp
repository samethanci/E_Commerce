			...
			<main role="main" class="col-10 ml-auto">
				<div class="row bg-light border-left border-danger p-3">
					...
					<div class="table-responsive">
								...
								<tbody>
								<c:forEach var="siparisDetay" items="${siparisDetaylari}">
									<tr>
										<th class="align-middle"></th>
										<th><input type="text" class="form-control" name="urun_id" readonly="readonly" value="${siparisDetay.adi}"></th>
										<th><input type="text" class="form-control" name="fiyat" readonly="readonly" value="${siparisDetay.fiyat}"></th>
										<th><input type="text" class="form-control" name="adet" readonly="readonly" value="${siparisDetay.adet}"></th>
									</tr>
									</c:forEach>
									</tbody>
									</table>
