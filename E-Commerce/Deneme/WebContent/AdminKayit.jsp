				...
				<div class="row bg-light border-left border-danger p-3">
					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
							<c:forEach var="yonetici" items="${adminListesi}">
								<tr>
										<th class="align-middle"></th>
										<th><input type="text" class="form-control" value="${yonetici.adi}"></th>
										<th><input type="email" class="form-control" readonly="readonly" value="${yonetici.e_posta}"></th>
										<th><input type="password" class="form-control" placeholder="Şifre" name="sifre"></th>
										<td>
										<form action="adminSil" method="post">
											<input type="hidden" name="e_posta" value="${yonetici.e_posta}">
								...
								<tr>
									<form class="needs-validation" action="adminEkle" method="post">	
										<th class="align-middle">?</th>
										<th><input type="text" class="form-control" placeholder="Ad Soyad" name="adi"></th>
										<th><input type="email" class="form-control" placeholder="E-mail" name="e_posta"></th>
										<th><input type="password" class="form-control" placeholder="Şifre" name="sifre"></th>
										<td>
